          ...
          >
            ...
            <div className="w-full sm:w-auto flex">
              <motion.div
                ...
                className="glass flex w-full items-start gap-4 rounded-2xl border border-border-custom/50 bg-background/50 p-5 shadow-[0_16px_50px_-22px_rgba(0,0,0,0.24)] hover-lift"
              >
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-sm font-bold text-foreground">48-Hour Rapid Sample Development</p>
                  <p className="text-xs text-muted-custom leading-relaxed">
                    From your design to a high-quality garment sample in just 48 hours, helping you approve styles and start bulk production faster.
                  </p>
                </div>
              </motion.div>
            </div>
