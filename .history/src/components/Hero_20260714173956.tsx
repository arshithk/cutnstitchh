...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-[55%_45%] lg:gap-16 lg:px-8 lg:py-10">
        <div className="flex flex-col gap-5 md:col-span-7 lg:col-span-1 lg:gap-6 lg:pr-8 self-start">
          <motion.div
        ...
        <motion.div
          ...
          className="relative mx-auto mt-10 w-full md:col-span-5 md:mt-0 lg:col-span-5 lg:max-w-none lg:self-center"
        >
          <motion.div
            animate={{ y: [0, -3, 0] }}
            transition={{ duration: 5, ease: "easeInOut", repeat: Infinity, repeatType: "mirror" }}
            whileHover={{ y: -6, scale: 1.02 }}
            className="relative mx-auto h-[470px] w-full overflow-hidden rounded-[2rem] bg-transparent shadow-[0_20px_45px_rgba(0,0,0,0.12)] transition-transform duration-500 ease-out sm:h-[520px] md:h-[560px] lg:h-[600px] xl:h-[640px]"
          >
