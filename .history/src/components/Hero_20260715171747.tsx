...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-transparent pt-[4.5rem] pb-2 sm:pt-[5rem] sm:pb-3 md:pt-[5.5rem] md:pb-4 lg:min-h-[72vh] lg:pt-[5rem] lg:pb-4 xl:pt-[5rem]"
    >
      <TextileSimulation />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-start gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-12 lg:gap-20 lg:px-8 lg:py-10">
        ...
        <motion.div
          ...
          className="relative mx-auto w-full md:col-span-5 lg:col-span-5 lg:max-w-none lg:self-start lg:justify-self-end md:-translate-y-17 lg:-translate-y-19 xl:-translate-y-21 md:-translate-x-6 lg:-translate-x-12 xl:-translate-x-14"
        >
          <motion.div
            animate={{ y: [0, -3, 0] }}
