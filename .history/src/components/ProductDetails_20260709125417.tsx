                ...
                {product.variants.map((variant) => {
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-2xl border p-4 text-left transition-all duration-200 ${isActive ? "border-accent-custom/70 bg-accent-custom/10 shadow-[0_0_0_1px_rgba(212,175,55,0.25)]" : "border-white/10 bg-black/20 hover:border-accent-custom/50 hover:bg-white/5"}`}
                    >
