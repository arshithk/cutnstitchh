...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-transparent pt-[7rem] pb-2 sm:pt-[7.5rem] sm:pb-3 md:pt-[8rem] md:pb-4 lg:min-h-[calc(100vh-5rem)] lg:pt-[7rem] lg:pb-4 xl:pt-[7.5rem]"
    >
      <TextileSimulation />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-8 lg:grid-cols-12 lg:gap-12 lg:px-8 lg:py-10">
        <div className="flex flex-col gap-5 md:col-span-7 lg:col-span-7 lg:gap-6 lg:pr-8">
          <motion.div
        ...
        <motion.div
          ...
          className="relative mx-auto mt-8 w-full md:col-span-5 md:mt-0 lg:col-span-5 lg:max-w-none"
        >
          <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-black/15 via-transparent to-black/10 blur-3xl opacity-75" />
          <div className="relative mx-auto h-[320px] w-full overflow-hidden rounded-[2.5rem] bg-black/0 shadow-[0_30px_90px_rgba(0,0,0,0.2)] transition-transform duration-500 ease-out hover:scale-[1.02] sm:h-[380px] md:h-[430px] lg:h-[490px] xl:h-[520px] lg:translate-y-4">
            <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-t from-black/45 via-transparent to-black/35 opacity-80" />
            <motion.div
              animate={{ y: [0, 10, 0] }}
          ...
          <div className="pointer-events-none absolute inset-x-0 -bottom-8 mx-auto h-[calc(100%+2rem)] w-full rounded-[2.5rem] bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.18),transparent_40%)] opacity-60" />
        </motion.div>
      </div>
