...
export default function IndustriesServed() {
  ...
  return (
    <section id="industries" ref={ref} className="relative overflow-hidden border-y border-border-custom/50 bg-card/25 py-16 sm:py-20 lg:py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((ind, idx) => (
            <motion.div
              ...
              className="bg-background border border-border-custom p-6 rounded-2xl flex flex-col gap-4 hover:border-accent-custom/40 transition-all hover-lift"
            >
