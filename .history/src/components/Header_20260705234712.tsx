...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full border-b border-black/10 bg-background/95 px-4 py-2 shadow-sm backdrop-blur transition-transform duration-300 ease-out supports-[backdrop-filter]:bg-background/80 sm:px-6 sm:py-5 lg:px-8 dark:border-white/10 ${
