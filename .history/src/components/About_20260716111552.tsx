        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-12 lg:gap-8 xl:gap-10">
          ...
          >
            ...
            <p className="text-base text-muted-custom leading-relaxed">
              Founded on the pillars of craftsmanship and technology, <strong className="text-accent-custom">Cut n Stitch Apparel</strong> has grown to become a trusted manufacturing partner for top-tier fashion brands, scaling startups, and corporate entities.
            </p>
            <p className="text-base text-muted-custom leading-relaxed">
