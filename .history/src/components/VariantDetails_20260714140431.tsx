          ...
          {variant.colors.length > 0 && (
            <div className="rounded-4xl border border-border-custom/70 bg-card/70 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.16)]">
              ...
              <motion.div
                ...
                className="mt-5 rounded-2xl border-2 border-accent-custom/40 bg-gradient-to-r from-accent-custom/15 to-accent-custom/5 px-4 py-3 text-sm font-semibold text-accent-custom shadow-sm"
              >
