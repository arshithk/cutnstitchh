...
function BrandWordmark() {
  return (
    <div className="flex flex-col items-start gap-0">
      ...
      <span className="text-[0.72rem] font-semibold uppercase tracking-[0.28em] text-foreground/80 sm:text-[0.78rem]">
        APPAREL.COM
      </span>
    </div>
  );
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div
          ...
          } flex-col gap-3 rounded-xl border border-border-custom/60 bg-background/95 p-3 shadow-sm sm:flex sm:w-auto sm:flex-row sm:items-center sm:justify-end sm:gap-3 sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none sm:text-base`}
        >
          <a
            href="#about"
