...
export default function Testimonials() {
  ...
  const testimonials: Testimonial[] = [
    ...
    {
      id: 3,
      quote: "The quality check standards at CutnStitch are top-notch. Our export order of 5,000 custom hoodies was packaged neatly and delivered directly to our custom clearances port.",
      author: "Marcus Vance",
  ...
  return (
    <section className="relative overflow-hidden border-y border-border-custom/50 bg-card/40 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-10 px-4 text-center sm:px-6 lg:px-8">
        ...
        {/* Testimonial Box */}
        <div className="relative min-h-[280px] w-full flex items-center justify-center">
