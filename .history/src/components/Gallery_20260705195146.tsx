...
export default function Gallery() {
  ...
  return (
    <section id="gallery" ref={ref} className="relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24">
          ...
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item) => (
              <motion.div
                ...
                className="bg-card border border-border-custom/60 rounded-3xl overflow-hidden cursor-pointer shadow-sm group hover:border-accent-custom/40 hover:shadow-md transition-all duration-300"
              >
                {/* SVG Visual Header */}
                <div className="aspect-[4/3] bg-foreground/[0.02] dark:bg-white/[0.02] flex items-center justify-center p-8 border-b border-border-custom/40 relative group-hover:bg-accent-custom/[0.02] transition-colors">
                  {item.svgGraphic}
        ...
        {selectedItem && (
          ...
          >
            ...
            >
              ...
              <div className="md:col-span-6 bg-foreground/[0.02] dark:bg-white/[0.02] flex items-center justify-center p-12 border-b md:border-b-0 md:border-r border-border-custom/40">
