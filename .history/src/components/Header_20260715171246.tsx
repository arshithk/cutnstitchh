...
function BrandWordmark() {
  return (
    <div className="inline-grid items-center gap-0 text-center">
      ...
      <span className="inline-block w-full text-[0.8rem] font-semibold lowercase tracking-[0.42em] text-foreground/80 leading-none sm:text-[0.9rem]">
        apparel.com
      </span>
    </div>
  );
        ...
        >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
            <Link
              href="/live-stock"
              onClick={() => setIsMenuOpen(false)}
              className="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/10 px-5 py-3 text-center text-sm font-semibold text-white transition duration-300 ease-out hover:-translate-y-0.5 hover:border-accent-custom hover:bg-accent-custom/10 hover:text-accent-custom sm:px-6"
            >
              Live Stock
            </Link>
            ...
            <a
              href="#contact"
              onClick={() => setIsMenuOpen(false)}
              className="inline-flex items-center justify-center rounded-xl border border-accent-custom bg-accent-custom/10 px-5 py-3 text-center text-sm font-semibold text-accent-custom transition duration-300 ease-out hover:-translate-y-0.5 hover:bg-accent-custom hover:text-black sm:px-6"
            >
              Get a Quote
            </a>
          </div>
