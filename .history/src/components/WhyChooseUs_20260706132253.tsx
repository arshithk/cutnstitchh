...
export default function WhyChooseUs() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      title: "Fast Delivery",
      desc: "Optimized cutting and sewing lines ensure production lead times of 7-15 days, helping you restock quickly.",
    },
    {
    ...
    },
    {
      ...
      title: "PAN India/Overseas Shipping",
      desc: "Seamless logistics coordination delivering directly to offices, warehouses, and fulfillment centers across India and overseas.",
    },
  ];
