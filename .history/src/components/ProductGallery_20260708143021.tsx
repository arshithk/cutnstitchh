...
export default function ProductGallery({ colors, selectedColor, onColorSelect, inquiryOnly = false }: ProductGalleryProps) {
    ...
    <div className="space-y-6">
      ...
      >
        <div className="relative aspect-4/5 overflow-hidden rounded-3xl">
          <Image
            src={activeColor?.imagePath ?? "/images/oversized-tshirt.jpg"}
