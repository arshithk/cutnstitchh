...
export default function ProductCategories() {
  ...
  return (
    <section id="products" className="scroll-mt-24 relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24" ref={containerRef}>
          ...
          {categories.map((cat, idx) => (
            ...
            >
              ...
              <div className="flex flex-col items-center w-full">
                <div className="relative mb-6 flex aspect-[4/5] w-full max-w-[180px] items-center justify-center rounded-xl bg-foreground/[0.02] transition-all duration-300 group-hover:scale-105 group-hover:bg-accent-custom/5 dark:bg-white/[0.02]">
                  {cat.imagePath ? (
