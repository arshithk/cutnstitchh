  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:gap-8 lg:grid-cols-12 lg:gap-12 lg:px-8 lg:py-10">
        ...
        <div className="relative flex items-center justify-center lg:col-span-5 lg:min-h-[560px]">
          <div className="pointer-events-none absolute inset-0 rounded-[2rem] bg-accent-custom/10 blur-[90px]" />
          <div className="relative z-10 h-[420px] w-full overflow-hidden rounded-[2rem] border border-border-custom/10 bg-card/70 shadow-2xl sm:h-[540px] lg:h-[680px] xl:h-[760px]">
            <Image
