        ...
        {colors.map((color) => {
          ...
          return (
            <button
              ...
              className={`group min-w-22 rounded-2xl border p-2 text-left transition-all duration-300 md:min-w-0 ${
                isSelected
            ...
            >
              <div className="relative h-20 w-20 overflow-hidden rounded-xl border border-white/10 transition-transform duration-500 group-hover:scale-105">
                <Image
