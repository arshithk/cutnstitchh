...
export default function About() {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24" ref={containerRef}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-24 border-t border-border-custom/60 pt-16">
