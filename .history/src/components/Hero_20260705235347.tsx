...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-background pt-36 pb-10 sm:pt-24 sm:pb-14 lg:min-h-screen lg:pt-24 lg:pb-16"
    >
      <TextileSimulation />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:gap-8 lg:grid-cols-12 lg:gap-10 lg:px-8">
        <div className="flex flex-col gap-5 lg:col-span-7 lg:gap-6">
          ...
          >
            <div className="mt-2 inline-flex w-fit items-center gap-2 rounded-full border border-accent-custom/25 bg-accent-custom/10 px-3 py-1 sm:mt-0">
