        ...
        <div className="flex flex-col gap-5 lg:col-span-7 lg:gap-6 lg:pr-8">
          ...
          >
            ...
            <motion.div
              ...
              className="glass mt-2 flex w-full flex-col gap-1.5 rounded-2xl border border-border-custom/50 bg-background/50 p-5 shadow-[0_16px_50px_-22px_rgba(0,0,0,0.24)] hover-lift sm:p-6"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-muted-custom">
                    ...
                    hours, helping you approve styles and start bulk production faster.
                  </p>
                </div>
              </div>
            </motion.div>
