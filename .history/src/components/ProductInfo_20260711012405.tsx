          ...
          {fabricOptions.map((variant) => {
            ...
            return (
              <button
                ...
                className={`flex h-full flex-col rounded-3xl border p-6 text-left transition duration-200 ${
                  isSelected
                    ? "border-accent-custom bg-accent-custom/10 shadow-[0_0_0_1px_rgba(212,175,55,0.2)]"
