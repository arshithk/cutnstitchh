      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-start gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-12 lg:gap-20 lg:px-8 lg:py-10">
        ...
        >
          <motion.div
            ...
            className="relative h-[500px] w-full overflow-hidden rounded-[2rem] bg-transparent shadow-[0_18px_50px_rgba(0,0,0,0.12)] transition-transform duration-500 ease-out sm:h-[540px] md:h-[560px] lg:h-[640px] xl:h-[680px]"
          >
