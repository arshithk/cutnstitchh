  ...
  return (
    <section
      ...
      style={isMobile ? { paddingTop: "calc(var(--header-height, 0px) + 1.5rem)" } : undefined}
       className="relative overflow-hidden bg-transparent pt-[7rem] pb-2 sm:pt-[7.5rem] sm:pb-3 md:pt-[8rem] md:pb-4 lg:min-h-[72vh] lg:pt-[7rem] lg:pb-4 xl:pt-[7.5rem]"
    >
      <TextileSimulation />
      ...
      <div className="relative z-10 mx-auto mt-6 flex justify-center pb-2 md:-mt-20 lg:-mt-40 lg:mt-6 lg:mb-4">
        <a
          href="#about"
