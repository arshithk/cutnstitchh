        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.35em] text-[#D4AF37] dark:text-[#F6D56A]">
                  Live Stock
                </p>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">Ready for dispatch</p>
                      </div>
                    </div>
                    <span className="text-sm font-semibold text-[#D4AF37] dark:text-[#F6D56A]">
                      {item.quantity} pcs
                    </span>
                  </div>
                ))}
