        ...
        >
          {steps.map((step, idx) => (
            <motion.div
              ...
              className="relative flex w-[280px] flex-shrink-0 snap-start flex-col gap-6 rounded-2xl border border-border-custom bg-background p-6 shadow-sm group sm:w-[300px] sm:p-7"
            >
