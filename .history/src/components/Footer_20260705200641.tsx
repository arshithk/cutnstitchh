...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-neutral-900 bg-neutral-950 pb-10 pt-16 text-neutral-300 sm:pt-20">
          ...
          <ul className="flex flex-col gap-3.5 text-sm text-neutral-400">
            <li className="flex gap-3 items-start">
              ...
              <span>
                ...
                Plot No. 124, Phase IV, Udyog Vihar,<br />
            ...
            <li className="flex gap-3 items-center">
              ...
              <a href="mailto:info@cutnstitch.com" className="hover:text-white transition-colors">
                info@cutnstitch.com
              </a>
            </li>
          </ul>
