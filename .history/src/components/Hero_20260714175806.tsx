...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-start gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-12 lg:gap-20 lg:px-8 lg:py-10">
        <div className="flex flex-col gap-5 md:col-span-7 lg:col-span-7 lg:gap-6 lg:pr-8 self-start">
          <motion.div
        ...
        <motion.div
          ...
          className="relative mx-auto w-full md:col-span-5 lg:col-span-5 lg:max-w-none lg:self-start lg:justify-self-end md:-translate-y-28 lg:-translate-y-36 xl:-translate-y-40 md:-translate-x-6 lg:-translate-x-12 xl:-translate-x-14"
        >
          <motion.div
            animate={{ y: [0, -3, 0] }}
              transition={{ duration: 5, ease: "easeInOut", repeat: Infinity, repeatType: "mirror" }}
              whileHover={{ y: -6, scale: 1.02 }}
              className="relative h-[500px] w-full overflow-hidden rounded-[2rem] bg-transparent shadow-[0_18px_50px_rgba(0,0,0,0.12)] transition-transform duration-500 ease-out sm:h-[540px] md:h-[560px] lg:h-[640px] xl:h-[680px] transform md:scale-105 lg:scale-110 xl:scale-110 origin-center"
          >
