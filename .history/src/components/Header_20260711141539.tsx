...
function BrandWordmark() {
  return (
    <div className="inline-grid items-center gap-0 text-center">
      <span className="inline-block w-full text-[1.03rem] font-extrabold uppercase tracking-[0.34em] text-[#d4af37] leading-none sm:text-[1.2rem]">
        CUT N STITCH
      </span>
      <span className="inline-block w-full text-[0.72rem] font-semibold lowercase tracking-[0.42em] text-foreground/80 leading-none sm:text-[0.78rem]">
        apparel.com
      </span>
    </div>
  );
