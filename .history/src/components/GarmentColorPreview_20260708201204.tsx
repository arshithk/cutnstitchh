...
const getProductImage = (productPrefix: string, selectedColour: string) => {
  return getImagePath(`${productPrefix} ${selectedColour.toLowerCase()}.jpg`);
};
...
export default function GarmentColorPreview({
  ...
  useEffect(() => {
    setPreviewImage(getProductImage(productPrefix, activeColor));
    setIsImageReady(true);
  }, [activeColor, productPrefix]);
