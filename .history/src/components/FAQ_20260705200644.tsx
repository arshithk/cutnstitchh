...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="scroll-mt-24 relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        {/* Header Block */}
        <div className="mb-12 flex flex-col gap-4 text-center sm:mb-14 lg:mb-16">
