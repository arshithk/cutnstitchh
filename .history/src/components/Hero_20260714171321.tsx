    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:gap-8 lg:grid-cols-12 lg:gap-12 lg:px-8 lg:py-10">
        ...
        <motion.div
          ...
          className="relative mx-auto mt-6 w-full lg:col-span-5 lg:mt-0 lg:max-w-none"
        >
          <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-black/20 via-transparent to-black/10 blur-3xl opacity-70" />
          <div className="relative mx-auto h-[360px] w-full overflow-hidden rounded-[2.5rem] border border-transparent bg-black/0 shadow-[0_30px_80px_rgba(0,0,0,0.24)] transition-transform duration-500 ease-out hover:scale-[1.02] sm:h-[420px] lg:h-[500px] xl:h-[540px]">
            <div className="absolute inset-0 bg-gradient-to-r from-black/35 via-transparent to-black/35 opacity-90" />
            <div className="relative h-full w-full scale-[1.01] overflow-hidden">
              <Image
          ...
          <div className="pointer-events-none absolute inset-x-0 -bottom-8 mx-auto h-[calc(100%+2rem)] w-full rounded-[2.5rem] bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.16),transparent_40%)] opacity-60" />
        </motion.div>
      </div>
