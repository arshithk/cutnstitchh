...
function BrandWordmark() {
  return (
    <div className="flex flex-col items-center gap-0 text-center">
      <span className="text-[1.03rem] font-extrabold uppercase tracking-[0.34em] text-[#d4af37] leading-none sm:text-[1.2rem]">
        CUT N STITCH
      </span>
      <span className="text-[0.72rem] font-semibold lowercase tracking-[0.28em] text-foreground/80 leading-none sm:text-[0.78rem]">
        apparel.com
      </span>
    </div>
  );
