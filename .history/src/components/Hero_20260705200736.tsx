...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-background pt-24 pb-16 sm:pt-28 sm:pb-20 lg:min-h-screen lg:pt-32 lg:pb-24">
      <TextileSimulation />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 md:gap-14 lg:grid-cols-12 lg:gap-16 lg:px-8">
      ...
      <div className="relative z-10 mx-auto mt-12 flex justify-center pb-2 lg:absolute lg:bottom-6 lg:left-1/2 lg:mt-0 lg:-translate-x-1/2">
        <a
          href="#about"
