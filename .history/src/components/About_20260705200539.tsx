...
export default function About() {
  ...
  return (
    <section id="about" className="scroll-mt-24 relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24" ref={containerRef}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 border-t border-border-custom/60 pt-10 sm:mt-20 sm:pt-14">
