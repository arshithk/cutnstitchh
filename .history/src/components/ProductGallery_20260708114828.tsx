  ...
  return (
    <div className="space-y-6">
      <motion.div
        ...
        className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-black/80 via-black/60 to-[#1a1408] p-3 shadow-[0_20px_70px_rgba(0,0,0,0.35)]"
      >
