    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-start gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-12 lg:gap-20 lg:px-8 lg:py-10">
        ...
        <motion.div
          ...
          className="relative mx-auto w-full md:col-span-5 lg:col-span-5 lg:max-w-none lg:self-start lg:justify-self-end md:-translate-y-16 lg:-translate-y-18 xl:-translate-y-20 md:-translate-x-6 lg:-translate-x-12 xl:-translate-x-14"
        >
          <motion.div
            animate={{ y: [0, -3, 0] }}
