      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-12 lg:gap-16 lg:px-8 lg:py-10">
        ...
        >
          <motion.div
            ...
            className="relative mx-auto h-[440px] w-full overflow-hidden rounded-[2rem] bg-transparent shadow-[0_20px_50px_rgba(0,0,0,0.12)] transition-transform duration-500 ease-out sm:h-[500px] md:h-[540px] lg:h-[580px] xl:h-[620px] lg:-translate-y-6"
          >
