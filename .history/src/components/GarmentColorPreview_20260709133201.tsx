    ...
    <div className="space-y-6">
      ...
      >
        <div className="mx-auto flex w-full max-w-122 items-center justify-center px-0 py-0 sm:px-1 sm:py-1">
          <div className="group relative w-full overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-2 shadow-[0_24px_70px_rgba(0,0,0,0.28)] sm:p-3 lg:p-4">
