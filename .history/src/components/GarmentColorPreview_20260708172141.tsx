    ...
    <div className="space-y-6">
      ...
      >
        <div className="mx-auto flex w-full max-w-[450px] items-center justify-center py-2 sm:py-3">
          <div className="group relative w-full max-w-[450px] overflow-hidden rounded-3xl border border-[#2b2b2b] bg-[#0f0f0f]/90 p-2 shadow-[0_18px_45px_rgba(0,0,0,0.24)] sm:p-3">
