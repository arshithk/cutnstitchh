...
import { LiveStockModal } from "./LiveStockModal";
import { productStockData } from "../data/productStock";
...
export default function ProductCategories() {
  ...
  const [activeStockProduct, setActiveStockProduct] = useState<string | null>(null);
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      imagePath: "/images/hoodie_model.png",
      svgPath: (
        <svg viewBox="0 0 100 100" className="w-24 h-24 drop-shadow-md">
          {/* Hood Inner */}
    ...
    },
    {
      ...
      imagePath: "/images/sweatshirt_model.png",
      svgPath: (
        <svg viewBox="0 0 100 100" className="w-24 h-24 drop-shadow-md">
          {/* Sweatshirt Body */}
    ...
    },
    {
      ...
      imagePath: "/images/tank_tops.webp",
      svgPath: (
        <svg viewBox="0 0 100 100" className="w-24 h-24 drop-shadow-md">
          {/* Olive Tank Top Body */}
    ...
    },
    {
      ...
      imagePath: "/images/corporate_wear.jpg",
      svgPath: (
        <svg viewBox="0 0 100 100" className="w-24 h-24 drop-shadow-md">
    ...
    },
    {
      ...
      imagePath: "/images/uniforms.avif",
      svgPath: (
        <svg viewBox="0 0 100 100" className="w-24 h-24 drop-shadow-md">
    ...
    },
    {
      ...
      imagePath: "/images/custom_merchandise.webp",
      svgPath: (
        <svg viewBox="0 0 100 100" className="w-24 h-24 drop-shadow-md">
          {/* Matte Black Tee */}
            ...
            >
              ...
              <div className="flex flex-col items-center w-full">
                <div className="relative mb-6 flex aspect-4/5 w-full max-w-45 items-center justify-center rounded-xl bg-foreground/2 transition-all duration-300 group-hover:scale-105 group-hover:bg-accent-custom/5 dark:bg-white/2">
                  {cat.imagePath && !imageErrors[cat.name] ? (
                    <img
                      src={cat.imagePath}
                      alt={cat.name}
              ...
              <div className="mt-6 flex w-full flex-col gap-2 sm:flex-row">
                <button
                  onClick={() => openStockModal(cat.name)}
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-accent-custom/30 bg-accent-custom/10 px-3 py-2.5 text-xs font-semibold text-accent-custom transition-all hover:border-accent-custom hover:bg-accent-custom hover:text-white cursor-pointer"
                >
                  <PackageOpen size={14} />
                  Live Stock
                </button>
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-border-custom px-3 py-2.5 text-xs font-semibold transition-all hover:border-accent-custom hover:bg-accent-custom hover:text-white cursor-pointer group-hover:shadow-sm"
                >
                  Inquire Now
