...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative border-y border-border-custom/50 bg-card/25 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 bg-background border border-border-custom/60 rounded-3xl p-8 shadow-md">
            {status === "success" ? (
              <motion.div
