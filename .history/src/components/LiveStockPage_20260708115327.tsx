...
export default function LiveStockPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-24 pt-28 sm:px-6 lg:px-8">
      <div className="rounded-4xl border border-white/10 bg-black/35 p-6 shadow-[0_20px_70px_rgba(0,0,0,0.24)] backdrop-blur sm:p-8 lg:p-10">
        ...
        <div className="mt-8 space-y-4">
          {filteredEntries.map((entry) => {
            ...
            return (
              <motion.div key={entry.slug} layout className="overflow-hidden rounded-3xl border border-white/10 bg-black/40">
          ...
          {filteredEntries.length === 0 ? (
            <div className="rounded-3xl border border-dashed border-white/10 bg-black/20 p-8 text-center text-sm text-muted-custom">
