        ...
        >
          ...
          <div className="flex flex-row flex-wrap items-center gap-3 sm:gap-4">
            <Link
              href="/live-stock"
              onClick={() => setIsMenuOpen(false)}
              className="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white px-4 py-2 text-center text-xs font-semibold text-black transition duration-300 ease-out hover:-translate-y-0.5 hover:border-accent-custom hover:bg-accent-custom/10 hover:text-black whitespace-nowrap"
            >
              Live Stock
            </Link>
            ...
            <a
              href="#contact"
              onClick={() => setIsMenuOpen(false)}
              className="inline-flex items-center justify-center rounded-xl border border-accent-custom bg-white px-4 py-2 text-center text-xs font-semibold text-black transition duration-300 ease-out hover:-translate-y-0.5 hover:bg-accent-custom hover:text-black whitespace-nowrap"
            >
              Get a Quote
            </a>
          </div>
