...
export default function StickyCTA({ productName }: StickyCTAProps) {
  return (
    <div className="sticky bottom-4 z-30 mt-10 rounded-[1.5rem] border border-accent-custom/30 bg-black/80 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.35)] backdrop-blur xl:bottom-6">
