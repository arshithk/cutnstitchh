...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-transparent pt-[7rem] pb-2 sm:pt-[7.5rem] sm:pb-3 md:pt-[8rem] md:pb-4 lg:min-h-[85vh] lg:pt-[7rem] lg:pb-4 xl:pt-[7.5rem]"
    >
      <TextileSimulation />
        ...
        >
          <motion.div
            animate={{ y: [0, -3, 0] }}
              ...
              className="relative h-[480px] w-full overflow-hidden rounded-[2rem] bg-transparent shadow-[0_18px_50px_rgba(0,0,0,0.12)] transition-transform duration-500 ease-out sm:h-[520px] md:h-[540px] lg:h-[560px] xl:h-[600px] transform md:scale-105 lg:scale-105 xl:scale-105 origin-center"
          >
