  ...
  return (
    <section className="mt-16">
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {related.map((product) => (
          <Link key={product.slug} href={`/products/${product.slug}`} className="group overflow-hidden rounded-3xl border border-white/10 bg-black/35 transition hover:-translate-y-1 hover:border-accent-custom/40">
