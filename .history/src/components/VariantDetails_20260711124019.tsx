    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 pb-24 pt-28 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div className="relative aspect-4/5 min-h-90 sm:min-h-107.5 lg:min-h-130 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.94),rgba(246,246,246,0.88)_58%,rgba(235,235,235,0.82))] p-4 sm:p-5 lg:p-6">
              <Image
