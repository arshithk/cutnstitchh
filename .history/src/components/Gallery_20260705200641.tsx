...
export default function Gallery() {
  ...
  return (
    <section id="gallery" ref={ref} className="scroll-mt-24 relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Header Block */}
        <div className="mb-12 flex flex-col gap-6 md:mb-14 md:flex-row md:items-end md:justify-between lg:mb-16">
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item) => (
              ...
              >
                {/* SVG Visual Header */}
                <div className="relative flex aspect-[4/3] items-center justify-center border-b border-border-custom/40 bg-foreground/[0.02] p-6 transition-colors group-hover:bg-accent-custom/[0.02] dark:bg-white/[0.02] sm:p-8">
                  {item.svgGraphic}
