...
export default function IndustriesServed() {
  ...
  const industries = [
    ...
    },
    {
      ...
      desc: "Custom college apparel, festival tees, and graduation souvenirs tailored for campus branding.",
    },
    {
    ...
    },
    {
      ...
      desc: "Athletic wear, sublimation-print jerseys, and activewear staples built for performance teams.",
    },
    {
  ...
  return (
    <section id="industries" ref={ref} className="scroll-mt-20 relative overflow-hidden border-y border-border-custom/50 bg-card/25 py-8 sm:py-10 lg:py-12">
