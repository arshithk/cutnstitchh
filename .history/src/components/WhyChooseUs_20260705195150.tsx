...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-choose-us" ref={ref} className="relative overflow-hidden bg-background py-16 sm:py-20 lg:py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {benefits.map((benefit, idx) => (
            <motion.div
              ...
              className="bg-card border border-border-custom/50 rounded-2xl p-6 flex flex-col gap-4 hover:border-accent-custom/40 transition-colors hover-lift"
            >
