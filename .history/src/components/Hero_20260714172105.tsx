...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:grid-cols-12 md:gap-10 lg:grid-cols-12 lg:gap-16 lg:px-8 lg:py-10">
        ...
        <motion.div
          ...
          className="relative mx-auto mt-10 w-full md:col-span-5 md:mt-0 lg:col-span-5 lg:max-w-none"
        >
          <motion.div
            animate={{ y: [0, -4, 0] }}
            transition={{ duration: 5, ease: "easeInOut", repeat: Infinity, repeatType: "mirror" }}
            whileHover={{ y: -6, scale: 1.02 }}
            className="relative mx-auto h-[420px] w-full overflow-hidden rounded-[2rem] bg-transparent shadow-[0_25px_60px_rgba(0,0,0,0.12)] transition-transform duration-500 ease-out sm:h-[470px] md:h-[520px] lg:h-[560px] xl:h-[600px] lg:-translate-y-4 lg:translate-x-8"
          >
            <div className="absolute inset-0 rounded-[2rem] bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.18),transparent_55%)] opacity-65" />
            <div className="absolute inset-0 rounded-[2rem] bg-gradient-to-br from-transparent via-black/10 to-transparent opacity-70" />
