  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 pb-24 pt-28 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="overflow-hidden rounded-[2rem] border border-border-custom/70 bg-card/70 shadow-[0_24px_80px_rgba(0,0,0,0.16)]">
        ...
        <div className="rounded-[2rem] border border-border-custom/70 bg-card/70 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.16)] sm:p-8">
          ...
          <div className="mt-8 space-y-4">
            <div>
              <h2 className="text-sm font-semibold uppercase tracking-[0.25em] text-accent-custom">Printing & Embroidery Compatibility</h2>
