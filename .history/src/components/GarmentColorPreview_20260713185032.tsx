      ...
      >
        <div className="mx-auto flex w-full max-w-122 items-center justify-center px-0 py-0 sm:px-1 sm:py-1">
          <div className="group relative w-full overflow-hidden rounded-[28px] border border-white/10 p-3 shadow-[0_24px_70px_rgba(0,0,0,0.28)] sm:p-4 lg:p-5" style={previewFrameStyle}>
            <div className="relative mx-auto aspect-3/4 w-full max-w-xl overflow-hidden rounded-3xl" style={imageContainerStyle}>
              <motion.div
                key={previewImage}
              ...
              >
                <div className="relative h-full w-full">
                  <Image
                    ...
                    priority
                    className={`${isJoggersPreview ? "object-contain" : "object-cover"} object-center transition-transform duration-500 ${isJoggersPreview ? "" : "group-hover:scale-[1.02]"}`}
