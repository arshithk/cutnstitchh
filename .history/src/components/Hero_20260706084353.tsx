    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:gap-8 lg:grid-cols-12 lg:gap-12 lg:px-8 lg:py-10">
        <div className="flex flex-col gap-5 lg:col-span-7 lg:gap-6 lg:pr-8">
          ...
          >
            <div className="inline-flex w-fit items-center rounded-full border border-accent-custom/25 bg-accent-custom/10 px-3 py-1.5 shadow-sm sm:px-4">
              <span className="mr-2 h-2 w-2 animate-pulse rounded-full bg-accent-custom" />
              <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-accent-custom sm:text-[11px]">
