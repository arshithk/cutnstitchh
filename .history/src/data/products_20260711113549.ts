    ...
    variants: [
      ...
      },
      {
        ...
        colors: [
          ...
          { name: "Dark Blue", hex: "#1f3b64", imagePath: "/images/hoodie-dark-blue.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        ...
        name: "Cotton Fleece 280 GSM Sweatshirt",
        gsm: "280 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A premium cotton fleece sweatshirt with a comfortable hand feel and strong structure.",
        heroImage: "/images/sweatshirt-grey.jpg",
        thumbnailImage: "/images/sweatshirt-grey.jpg",
        colors: [
          { name: "Grey", hex: "#6b7280", imagePath: "/images/sweatshirt-grey.jpg" },
          { name: "Maroon", hex: "#6d2c2c", imagePath: "/images/sweatshirt-maroon.jpg" },
          { name: "Dark Blue", hex: "#1f3b64", imagePath: "/images/sweatshirt-dark-blue.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
    ...
    variants: [
      {
        ...
        heroImage: "/images/shorts-white.jpg",
        thumbnailImage: "/images/shorts-white.jpg",
        colors: [
          { name: "White", hex: "#f5f5f2", imagePath: "/images/shorts-white.jpg" },
          { name: "Black", hex: "#111111", imagePath: "/images/shorts-black.jpg" },
          { name: "Navy Blue", hex: "#20354d", imagePath: "/images/shorts-navy-blue.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
      ...
      },
      {
        ...
        heroImage: "/images/shorts-grey.jpg",
        thumbnailImage: "/images/shorts-grey.jpg",
        colors: [
          { name: "Grey", hex: "#6b7280", imagePath: "/images/shorts-grey.jpg" },
          { name: "Maroon", hex: "#6d2c2c", imagePath: "/images/shorts-maroon.jpg" },
          { name: "Brown", hex: "#6f4b2f", imagePath: "/images/shorts-brown.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
      ...
      },
      {
        ...
        heroImage: "/images/shorts-dark-blue.jpg",
        thumbnailImage: "/images/shorts-dark-blue.jpg",
        colors: [
          { name: "Dark Blue", hex: "#1f3b64", imagePath: "/images/shorts-dark-blue.jpg" },
          { name: "Black", hex: "#111111", imagePath: "/images/shorts-black.jpg" },
          { name: "Red", hex: "#a52424", imagePath: "/images/shorts-red.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
      ...
      },
      {
        ...
        heroImage: "/images/shorts-orange.jpg",
        thumbnailImage: "/images/shorts-orange.jpg",
        colors: [
          { name: "Orange", hex: "#c96a17", imagePath: "/images/shorts-orange.jpg" },
          { name: "Purple", hex: "#6b3fa0", imagePath: "/images/shorts-purple.jpg" },
          { name: "Yellow", hex: "#f2c94c", imagePath: "/images/shorts-yellow.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
    ...
    variants: [
      {
        ...
        heroImage: "/images/joggers-white.jpg",
        thumbnailImage: "/images/joggers-white.jpg",
        colors: [
          { name: "White", hex: "#f5f5f2", imagePath: "/images/joggers-white.jpg" },
          { name: "Black", hex: "#111111", imagePath: "/images/joggers-black.jpg" },
          { name: "Navy Blue", hex: "#20354d", imagePath: "/images/joggers-navy-blue.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
      ...
      },
      {
        ...
        heroImage: "/images/joggers-grey.jpg",
        thumbnailImage: "/images/joggers-grey.jpg",
        colors: [
          { name: "Grey", hex: "#6b7280", imagePath: "/images/joggers-grey.jpg" },
          { name: "Maroon", hex: "#6d2c2c", imagePath: "/images/joggers-maroon.jpg" },
          { name: "Brown", hex: "#6f4b2f", imagePath: "/images/joggers-brown.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
      ...
      },
      {
        ...
        heroImage: "/images/joggers-dark-blue.jpg",
        thumbnailImage: "/images/joggers-dark-blue.jpg",
        colors: [
          { name: "Dark Blue", hex: "#1f3b64", imagePath: "/images/joggers-dark-blue.jpg" },
          { name: "Black", hex: "#111111", imagePath: "/images/joggers-black.jpg" },
          { name: "Red", hex: "#a52424", imagePath: "/images/joggers-red.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
      ...
      },
      {
        ...
        heroImage: "/images/joggers-orange.jpg",
        thumbnailImage: "/images/joggers-orange.jpg",
        colors: [
          { name: "Orange", hex: "#c96a17", imagePath: "/images/joggers-orange.jpg" },
          { name: "Purple", hex: "#6b3fa0", imagePath: "/images/joggers-purple.jpg" },
          { name: "Yellow", hex: "#f2c94c", imagePath: "/images/joggers-yellow.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Perfect for sublimation and bold graphics on performance fabrics.",
...
const baseProducts: ProductDetail[] = [
  ...
  },
  {
    ...
    colors: [
      { name: "Bottle Green", hex: "#3f6b3f", imagePath: "/images/shorts.jpg" },
      { name: "Black", hex: "#111111", imagePath: "/images/shorts.jpg" },
      { name: "Air Force Blue", hex: "#5d8aa8", imagePath: "/images/shorts.jpg" },
      { name: "Navy Blue", hex: "#22334d", imagePath: "/images/shorts.jpg" },
      { name: "Dark Grey", hex: "#4b5563", imagePath: "/images/shorts.jpg" },
      { name: "Maroon", hex: "#6d2c2c", imagePath: "/images/shorts.jpg" },
      { name: "Olive", hex: "#6b6e2d", imagePath: "/images/shorts.jpg" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    pricing: [
  ...
  },
  {
    ...
    heroImage: "/images/joggers-white.jpg",
    colors: [
      { name: "Bottle Green", hex: "#3f6b3f", imagePath: "/images/joggers.jpg" },
      { name: "Black", hex: "#111111", imagePath: "/images/joggers.jpg" },
      { name: "Air Force Blue", hex: "#5d8aa8", imagePath: "/images/joggers.jpg" },
      { name: "Navy Blue", hex: "#22334d", imagePath: "/images/joggers.jpg" },
      { name: "Dark Grey", hex: "#4b5563", imagePath: "/images/joggers.jpg" },
      { name: "Maroon", hex: "#6d2c2c", imagePath: "/images/joggers.jpg" },
      { name: "Olive", hex: "#6b6e2d", imagePath: "/images/joggers.jpg" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    pricing: [
      { min: 100, max: 999, price: 102 },
