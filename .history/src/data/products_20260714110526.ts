...
const DESCRIPTION_KEYWORDS =
  "DTF Printing, DTG Printing (Cotton), Screen Printing, Sublimation (Polyester), Embroidery, Heat Transfer, Puff Printing, Vinyl Printing; ideal for Corporate Uniforms, School Uniforms, College Uniforms, Sportswear, Promotional Apparel, Hospitality Uniforms, Restaurant Uniforms, Industrial Uniforms, Team Wear, Event Merchandise. Supports Bulk Manufacturing, Premium Quality, Comfortable Fit, Durable Stitching, Breathable Fabric, Custom Branding, Logo Printing. Made in India.";
...
function enrichDescription(text: string) {
  ...
  // Ensure we don't duplicate keywords if already present
  if (base.includes("DTF Printing") || base.includes("Made in India")) return base;

  return `${base} ${DESCRIPTION_KEYWORDS}`;
}
