...
export const catalogCategories: CatalogCategory[] = [
  ...
  },
  {
    ...
    variants: [
      {
        slug: "cotton-fleece-280gsm-hoodie",
        name: "Cotton Fleece 280 GSM Hoodie",
        gsm: "280 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A heavyweight cotton fleece hoodie with a soft hand feel and excellent structure for premium merch.",
        heroImage: "/images/hoodie-white.jpg",
      ...
      {
        slug: "polycotton-fleece-260gsm-hoodie",
        name: "PolyCotton Fleece 260 GSM Hoodie",
        gsm: "260 GSM",
        fabric: "PolyCotton Fleece",
        fit: "Regular Fit",
        description: "A resilient polycotton fleece hoodie suited to bulk orders and repeat branding programs.",
      ...
      {
        slug: "french-terry-240gsm-hoodie",
        name: "French Terry 240 GSM Hoodie",
        gsm: "240 GSM",
        fabric: "French Terry",
        fit: "Relaxed Fit",
        description: "A lighter yet premium hoodie fabric that feels comfortable and modern for fashion-led collections.",
        ...
        productDescription: "French Terry brings a softer texture and a more contemporary finish, making it ideal for premium casualwear and retail drops.",
        categorySlug: "hoodie",
      },
    ],
  },
  {
    ...
    variants: [
      {
        slug: "cotton-fleece-260gsm-sweatshirt",
        name: "Cotton Fleece 260 GSM Sweatshirt",
        gsm: "260 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
      ...
      {
        slug: "polycotton-fleece-240gsm-sweatshirt",
        name: "PolyCotton Fleece 240 GSM Sweatshirt",
        gsm: "240 GSM",
        fabric: "PolyCotton Fleece",
        fit: "Regular Fit",
        description: "A durable polycotton fleece sweatshirt that balances comfort, structure, and easy care.",
        ...
        productDescription: "The polycotton blend gives these sweatshirts lasting shape retention and dependable comfort for repeat orders.",
        categorySlug: "sweatshirt",
      },
      {
        slug: "french-terry-220gsm-sweatshirt",
        name: "French Terry 220 GSM Sweatshirt",
        gsm: "220 GSM",
        fabric: "French Terry",
        fit: "Relaxed Fit",
        description: "A softer, more contemporary sweatshirt fabric for premium casualwear and lifestyle merch.",
        heroImage: "/images/sweatshirt-brown.jpg",
        thumbnailImage: "/images/sweatshirt-brown.jpg",
        colors: [
          { name: "Brown", hex: "#6f4b2f", imagePath: "/images/sweatshirt-brown.jpg" },
          { name: "Orange", hex: "#c96a17", imagePath: "/images/sweatshirt-orange.jpg" },
          { name: "Yellow", hex: "#f2c94c", imagePath: "/images/sweatshirt-yellow.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Perfect for lightweight print placement and premium branding details.",
        embroideryCompatibility: "A great base for clean, polished embroidered logos.",
        productDescription: "French Terry offers a modern hand feel and elevated comfort, making it ideal for fashion-first sweatshirt ranges.",
        categorySlug: "sweatshirt",
      },
    ],
  },
