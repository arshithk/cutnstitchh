  ...
  return {
    ...
    variants: product.variants?.map((variant) => ({
    ...
    })),
      {
        ...
        sizes: ["S", "M", "L", "XL", "2XL", "3XL"],
        moq: "100 Pieces",
        printingCompatibility: "Screen printing, embroidery, and heat transfer all work well on this lightweight oversized tee.",
        embroideryCompatibility: "Embroidery is suitable for chest logos and premium stitched detailing.",
        productDescription: "A lightweight oversized round neck tee for modern casualwear and premium branding.",
        categorySlug: "oversized",
      },
  };
});
