...
export const catalogCategories: CatalogCategory[] = [
  ...
  },
  {
    ...
    slug: "hoodie",
    name: "Hoodie",
    description: "Premium fleece hoodies with a soft hand feel, strong structure, and reliable branding performance.",
    heroImage: "/images/hoodie-white.jpg",
    variants: [
      {
        slug: "cotton-fleece-300gsm-hoodie-zip",
        name: "Cotton Fleece 300 GSM Hoodie (With Zip)",
        gsm: "300 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A lightweight fleece hoodie with zip closure for elevated casualwear and branded streetwear lines.",
        heroImage: "/images/hoodie-white.jpg",
        ...
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Screen printing and heat transfer are well suited to the smooth fleece face.",
        embroideryCompatibility: "Embroidery works beautifully for chest logos and sleeve branding.",
        productDescription: "This zip hoodie delivers comfort, structure, and a polished finish that supports premium merch, teamwear, and seasonal drops.",
        categorySlug: "hoodie",
      },
      {
        slug: "cotton-fleece-300gsm-hoodie-no-zip",
        name: "Cotton Fleece 300 GSM Hoodie (Without Zip)",
        gsm: "300 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A classic fleece hoodie designed for comfort, durability, and premium custom branding.",
        ...
        colors: [
          ...
          { name: "Blue", hex: "#1f3b64", imagePath: "/images/hoodie-dark-blue.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Excellent for screen printing and transfer methods on a soft fleece surface.",
        embroideryCompatibility: "Strong for front chest embroidery and premium logo placements.",
        productDescription: "The cotton fleece construction brings softness and warmth while retaining the structure needed for repeat branded apparel.",
        categorySlug: "hoodie",
      },
      {
        slug: "cotton-fleece-360gsm-hoodie-zip",
        name: "Cotton Fleece 360 GSM Hoodie (With Zip)",
        gsm: "360 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A heavier zip hoodie with elevated warmth and a premium, substantial hand feel.",
        ...
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Ideal for bold prints and crisp heat transfer on heavier fleece.",
        embroideryCompatibility: "A robust base for premium embroidery on the chest or sleeve.",
        productDescription: "The 360 GSM fleece weight creates a more premium garment for cold-weather merch, staff uniforms, and seasonal collections.",
        categorySlug: "hoodie",
      },
      {
        slug: "cotton-fleece-360gsm-hoodie-no-zip",
        name: "Cotton Fleece 360 GSM Hoodie (Without Zip)",
        gsm: "360 GSM",
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A premium heavyweight fleece hoodie designed for comfort and standout branded apparel.",
        ...
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Supports screen printing and transfer applications with good opacity and finish.",
        embroideryCompatibility: "Crafted well for premium embroidery on the front or hood panel.",
        productDescription: "This heavier cotton fleece hoodie combines warmth, density, and a refined silhouette for premium merchandise programs.",
        categorySlug: "hoodie",
      },
      {
        slug: "polycotton-fleece-300gsm-hoodie-zip",
        name: "PolyCotton Fleece 300 GSM Hoodie (With Zip)",
        gsm: "300 GSM",
        fabric: "PolyCotton Fleece",
        fit: "Regular Fit",
        description: "A versatile polycotton fleece zip hoodie with excellent durability and polished presentation.",
        heroImage: "/images/hoodie-purple.jpg",
        thumbnailImage: "/images/hoodie-purple.jpg",
        colors: [
        ...
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Strong option for screen printing and transfer work with consistent coverage.",
        embroideryCompatibility: "Handles embroidery well for locations that need crisp detail and structure.",
        productDescription: "The polycotton fleece blend offers a balanced mix of softness, strength, and easy customization for high-volume orders.",
        categorySlug: "hoodie",
      },
      {
        slug: "polycotton-fleece-300gsm-hoodie-no-zip",
        name: "PolyCotton Fleece 300 GSM Hoodie (Without Zip)",
        gsm: "300 GSM",
        fabric: "PolyCotton Fleece",
        fit: "Regular Fit",
        description: "A practical fleece hoodie that combines ease of wear with dependable branding performance.",
        heroImage: "/images/hoodie-yellow.jpg",
        thumbnailImage: "/images/hoodie-yellow.jpg",
        colors: [
        ...
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Reliable for screen printing, transfer, and direct branding applications.",
        embroideryCompatibility: "An excellent option for premium embroidery and strong logo definition.",
        productDescription: "This polycotton fleece hoodie offers dependable warmth and a smooth finish for branded apparel and official uniforms.",
        categorySlug: "hoodie",
      },
    ],
  },
  {
    ...
    slug: "sweatshirt",
    name: "Sweatshirt",
    description: "Soft, elevated sweatshirts crafted for everyday comfort, corporate merch, and premium branded apparel.",
    ...
    variants: [
      {
        ...
        fit: "Regular Fit",
        description: "A premium cotton French Terry sweatshirt with a plush interior and a clean, elevated silhouette.",
        heroImage: "/images/sweatshirt-white.jpg",
        ...
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Screen printing and transfer methods produce strong results on this soft French Terry surface.",
        embroideryCompatibility: "Excellent for chest logos and premium embroidered branding.",
        productDescription: "The cotton French Terry construction gives this sweatshirt warmth, drape, and a comfortable finish for merchandising and teamwear.",
      ...
      },
      {
        ...
        fabric: "Cotton Fleece",
        fit: "Regular Fit",
        description: "A heavier cotton fleece sweatshirt designed for premium comfort and seasonal branding.",
        ...
        colors: [
          ...
          { name: "Brown", hex: "#6f4b2f", imagePath: "/images/sweatshirt-brown.jpg" },
        ],
        sizes: ["S", "M", "L", "XL", "2XL"],
        moq: "100 Pieces",
        printingCompatibility: "Reliable for bold prints and durable transfer applications.",
        embroideryCompatibility: "Great for structured embroidery with a premium finish.",
        productDescription: "This cotton fleece sweatshirt offers a heavier weight and strong visual presence for cold-weather merchandise and uniform programs.",
        categorySlug: "sweatshirt",
      },
    ],
  },
