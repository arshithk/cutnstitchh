...
function buildAvailableColors(imagePath: string, scope?: string, context?: ProductImageContext): ProductColor[] {
  const palette = scope === "shorts" || scope === "joggers" ? shortsAndJoggersColorPalette : standardAvailableColorPalette;

  return palette.map((color) => ({
    ...color,
    imagePath: context ? getProductImagePath(context, color.name, imagePath) : imagePath,
  }));
}
