    ...
    variants: [
      {
        ...
        heroImage: "/images/regular-fit-tshirt-white.jpg",
        thumbnailImage: "/images/regular-fit-tshirt-red
        .jpg",
        colors: [
 ...
 * Falls back to sensible default tiers when no product entry exists (e.g. hoodie, sweatshirt).
 */
export function getProductPricingByCategorySlug(categorySlug: string): ProductPricingTier[] {
  ...
  // Fallback for categories without a matching product entry (e.g. hoodie, sweatshirt)
  const fallbacks: Record<string, ProductPricingTier[]> = {
    hoodie: [
      { min: 100, max: 999, price: 145 },
      { min: 1000, max: 4999, price: 138 },
      { min: 5000, price: 132 },
    ],
    sweatshirt: [
      { min: 100, max: 999, price: 128 },
  ...
  return fallbacks[categorySlug] ?? [
    { min: 100, max: 999, price: 110 },
    { min: 1000, max: 4999, price: 105 },
    { min: 5000, price: 100 },
  ];
}
...
const baseProducts: ProductDetail[] = [
  ...
  },
  {
    ...
    colors: [
      { name: "Bottle Green", hex: "#3f6b3f", imagePath: "" },
      { name: "Black", hex: "#111111", imagePath: "" },
      { name: "Air Force Blue", hex: "#5d8aa8", imagePath: "" },
      { name: "Navy Blue", hex: "#22334d", imagePath: "" },
      { name: "Dark Grey", hex: "#4b5563", imagePath: "" },
      { name: "Maroon", hex: "#6d2c2c", imagePath: "" },
      { name: "Olive", hex: "#6b6e2d", imagePath: "" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    pricing: [
