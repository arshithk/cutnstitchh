...
interface GalleryItem {
  id: number;
  title: string;
  category: "tshirts" | "corporate" | "dyeing";
...
export default function Gallery() {
  const [filter, setFilter] = useState<"all" | "tshirts" | "corporate" | "dyeing">("all");
    ...
    if (target) {
      ...
      setTimeout(() => {
        const selectEvent = new CustomEvent("select-product", {
          detail: {
            product: itemName.includes("Tee") ? "Oversized T-Shirts" : "Corporate Wear",
