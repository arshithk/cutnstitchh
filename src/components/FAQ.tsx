...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="scroll-mt-20 relative overflow-hidden bg-background py-10 sm:py-12 lg:py-14">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        {/* Header Block */}
        <div className="mb-8 flex flex-col gap-3 text-center sm:mb-10 lg:mb-12">
