...
async function main() {
    ...
    // Generate Mayuri Inovation
    await createInteractiveCatalog(browser, "Mayuri Inovation", "/images/mayuri-logo.png", "vidhyashankar@cutnstitchapparel.com", "+91 9994828850", "N/A", "mayuri-catalog-with-pricing", true, variants);
    await createInteractiveCatalog(browser, "Mayuri Inovation", "/images/mayuri-logo.png", "vidhyashankar@cutnstitchapparel.com", "+91 9994828850", "N/A", "mayuri-catalog-without-pricing", false, variants);

    await browser.close();
    console.log("All Mayuri complete!");
}
